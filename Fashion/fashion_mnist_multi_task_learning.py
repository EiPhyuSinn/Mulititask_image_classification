...
def main(args):
    ...
    # ... network, loss, evaluation, train, summary code unchanged ...
        ...
        while epoch < n_epoch:
            for _ in range(m // n_batch_size + 1):
                ...
                if global_step_value % 1000 == 0:
                    ...
                    print("Checkpoint saved at step:", global_step_value)

        # ✅ SAVE FINAL MODEL
        saver.save(sess, os.path.join(save_dir, "final_model.ckpt"))
